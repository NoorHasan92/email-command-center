...
export default function LoginClient() {
  ...
  useEffect(() => {
    if (urlError === "OAuthAccountNotLinked") {
      setError("This email is already associated with an account. Please sign in with your password and link your Google account in Settings.");
    }
  }, [urlError]);
      ...
      <div className="w-full max-w-[400px] flex flex-col gap-6">
        ...
        <div className="flex flex-col items-center text-center gap-2 mb-2">
          ...
          <p className="text-sm text-muted-foreground">
            Sign in to {APP_CONFIG.name} to continue
          </p>
        </div>
        ...
        <p className="text-center text-sm text-muted-foreground">
          ...
          <Link href={`/register?callbackUrl=${encodeURIComponent(callbackUrl)}`} className="text-primary hover:underline font-medium">
            Sign up
          </Link>
        </p>
